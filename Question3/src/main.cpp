...
void updateInstanceObj(cShaderManager* pShaderManager, cVAOManager* pVAOManager, glm::mat4x4 matView, glm::mat4x4 matProjection)
{
        ...
        itCurrentMesh++)
    {
        ...
        //{
        //    pCurrentMeshObject->position = ::g_pTheLightManager->plight[6]->position;
        //}
...
{
    //point light
    ::g_pTheLightManager->plight[8]->type = cLight::LightType::LIGHT_POINT;
    ::g_pTheLightManager->plight[8]->diffuse = glm::vec4(2.2f, 0.4f, 0.0f, 1.0f);
    ::g_pTheLightManager->plight[8]->position = glm::vec4(34.0f, 120.0f, 45.0f, 1.0f);
    ::g_pTheLightManager->plight[8]->attenuation = glm::vec4(0.87f, 0.0001f, 0.00001f, 1.0f);
    ::g_pTheLightManager->plight[8]->turnON = 0;
}
